...
from network.ptBEV1 import ptBEVnet
...
def main(args):
    # 初始化TensorBoard
    writer = SummaryWriter(log_dir='runs/BEV_training')
    ...
    while True:
        ...
        for i_iter,(_,train_vox_label,train_grid,_,train_pt_fea) in enumerate(train_dataset_loader):
            ...
            if global_iter % check_iter == 0:
                ...
                with torch.no_grad():
                    ...
                    for i_iter_val,(_,val_vox_label,val_grid,val_pt_labs,val_pt_fea) in enumerate(val_dataset_loader):
                        ...
                        # print(f"Validation iteration: {i_iter_val}")
                        ...
                        val_loss_list.append(loss.detach().cpu().numpy())
                         # 记录验证损失和mIoU
                        writer.add_scalar('Validation/Loss', np.mean(val_loss_list), global_iter)


                    print("[DEBUG] Validation loop completed.")
                ...
                writer.add_scalar('Validation/mIoU', val_miou, global_iter)
            ...
            try:
                ...
                # 记录训练损失
                writer.add_scalar('Train/Loss', np.mean(loss_list), global_iter)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--model_save_path', default='./SemKITTI_polarseg_attentive.pt')
